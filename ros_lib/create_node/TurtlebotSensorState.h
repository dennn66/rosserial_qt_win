...
namespace create_node
{
  ...
  class TurtlebotSensorState : public ros::Msg
  {
    public:
      ...
      double requested_right_velocity;
      double requested_left_velocity;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 4) = (u_requested_velocity.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_requested_velocity.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_requested_velocity.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_requested_velocity.base >> (8 * 7)) & 0xFF;
      ...
      *(outbuffer + offset + 4) = (u_requested_radius.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_requested_radius.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_requested_radius.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_requested_radius.base >> (8 * 7)) & 0xFF;
      ...
      *(outbuffer + offset + 4) = (u_requested_right_velocity.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_requested_right_velocity.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_requested_right_velocity.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_requested_right_velocity.base >> (8 * 7)) & 0xFF;
      ...
      *(outbuffer + offset + 4) = (u_requested_left_velocity.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_requested_left_velocity.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_requested_left_velocity.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_requested_left_velocity.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->requested_left_velocity);
      *(outbuffer + offset + 0) = (this->encoder_counts_left >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (this->encoder_counts_left >> (8 * 1)) & 0xFF;
      offset += sizeof(this->encoder_counts_left);
      *(outbuffer + offset + 0) = (this->encoder_counts_right >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (this->encoder_counts_right >> (8 * 1)) & 0xFF;
      offset += sizeof(this->encoder_counts_right);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_requested_velocity.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_requested_velocity.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_requested_velocity.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_requested_velocity.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_requested_velocity.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_requested_velocity.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_requested_velocity.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_requested_velocity.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      ...
      u_requested_radius.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_requested_radius.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_requested_radius.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_requested_radius.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_requested_radius.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_requested_radius.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_requested_radius.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_requested_radius.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      ...
      u_requested_right_velocity.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_requested_right_velocity.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_requested_right_velocity.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_requested_right_velocity.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_requested_right_velocity.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_requested_right_velocity.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_requested_right_velocity.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_requested_right_velocity.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      ...
      u_requested_left_velocity.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_requested_left_velocity.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_requested_left_velocity.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_requested_left_velocity.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_requested_left_velocity.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_requested_left_velocity.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_requested_left_velocity.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_requested_left_velocity.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->requested_left_velocity = u_requested_left_velocity.real;
      offset += sizeof(this->requested_left_velocity);
      this->encoder_counts_left =  ((uint16_t) (*(inbuffer + offset)));
      this->encoder_counts_left |= ((uint16_t) (*(inbuffer + offset + 1))) << (8 * 1);
      offset += sizeof(this->encoder_counts_left);
      this->encoder_counts_right =  ((uint16_t) (*(inbuffer + offset)));
      this->encoder_counts_right |= ((uint16_t) (*(inbuffer + offset + 1))) << (8 * 1);
      offset += sizeof(this->encoder_counts_right);
     return offset;
    }

    const char * getType(){ return "create_node/TurtlebotSensorState"; };
    const char * getMD5(){ return "c90b212991491c57451ea5d68e77f3cf"; };
